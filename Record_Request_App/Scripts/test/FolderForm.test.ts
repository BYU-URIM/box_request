...
test("If inputIsValid returns false because of name length, then return an error message unique to overly long folder names", () => {
    folderForm.folderName = "folder 00000000000000000000000000000000000000000000"
    console.log(folderForm.inputIsValid)
    expect(folderForm.errorMessage).toBe("The new folder name must be less than 50 characters.")
})